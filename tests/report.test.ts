...
Deno.test("formatReport", () => {
	...
	assertStringIncludes(r, "timeline en — 14.00 s");
	assertStringIncludes(r, "running time: en 14.00 s, sk 13.00 s");
...
Deno.test("formatBoard", () => {
	...
	assertStringIncludes(b, "plants pop, one by one — `pops` (×3, 0.74 s)");
